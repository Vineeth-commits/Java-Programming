...
class ConditionalAndLoopsPractise  {
    ...
    // 17. Prints message in the form of mb and kb
    ...
    // 20. mins is converted to years and days
    ...
    // 21. Sum of the first and last digit
    public static int sumFirstAndLastDigit(int number){
        ...
        if(number>0){
            ...
            return ((storeNumber/(digit/10))+(storeNumber%10));
        }
        else if(number==0)
            return 0;
        else
